            ...
            if (editor.queryCommandSupported(commandName)) {
                ...
                if(commandName == "fontSize"){
                  if(document.getSelection().anchorNode.parentNode.tagName != "SPAN"){
                    ...
                    }).css('font-size', commandValue).prop('outerHTML');
                    document.execCommand('insertHTML', true, fontString);
                  }else {
                    //修正字体大小
                    if(window.getSelection().toString() == ''){
                      $(document.getSelection().anchorNode.parentNode).css("font-size", commandValue);
                    }else if(window.getSelection().toString() == document.getSelection().anchorNode.data){
                      $(document.getSelection().anchorNode.parentNode).css("font-size", commandValue);
                    }else {
                      var fontString = $('<span />', {
                          'text': document.getSelection()
                  ...
                  if(document.getSelection().anchorNode.parentNode.tagName != "SPAN"){
                    ...
                    var fontString = $('<span />', {
                        'text': document.getSelection()
                    }).css('font-family', commandValue).prop('outerHTML');
                    document.execCommand('insertHTML', true, fontString);
                  }else {
                    if(window.getSelection().toString() == ''){
                      $(document.getSelection().anchorNode.parentNode).css("font-family", commandValue)
                    }else if(window.getSelection().toString() == document.getSelection().anchorNode.data){
                      $(document.getSelection().anchorNode.parentNode).css("font-family", commandValue)
                    }else {
                      var fontString = $('<span />', {
...
_e(function (E, $) {
    ...
    E.fn.disable = function () {
        ...
        this.txt.$txt.removeAttr('spellcheck');
    ...
    E.fn.enable = function () {
        ...
        this.txt.$txt.attr('spellcheck', 'false');
    ...
    E.fn.destroy = function () {
        ...
        if (valueNodeName === 'div') {
            ...
            $valueContainer.removeAttr('spellcheck');
    ...
    E.fn.undestroy = function () {
        ...
        if (valueNodeName === 'div') {
            ...
            $valueContainer.attr('spellcheck', 'false');
...
_e(function (E, $) {
    ...
    Menu.fn.updateSelected = function () {
        ...
        // 存储结果、显示效果
        self.changeSelectedState(state, result);
    };

    // 切换选中状态、显示效果
    Menu.fn.changeSelectedState = function (state, result) {
        var self = this;
        var selected = self.selected;
        ...
        if (state != null && typeof state === 'boolean') {
            if (selected === state) {
                // 计算结果和当前的状态一样
                if(self.id == "fontfamily"){
                  if(result != false && result.style.fontFamily != ''){
                    if($("#divFontFamily").length <= 0){
                      self.$domSelected.prepend("<div id='divFontFamily'>" + result.style.fontFamily.replaceAll("\"","") + "</div>");
                    }else {
                      $("#divFontFamily").text(result.style.fontFamily.replaceAll("\"",""));
                    }
                  }
                }else if(self.id == "fontsize") {
                  if(result != false && result.style.fontSize != ''){
                    if($("#divFontSize").length <= 0){
                      self.$domSelected.prepend("<div id='divFontSize'>" + result.style.fontSize + "</div>");
                    }else {
                      $("#divFontSize").text(result.style.fontSize);
                    }
                  }
                }
                return;
    ...
    DropList.fn.bindEvent = function () {
        ...
        $list.on('click', 'a[commandValue]', function (e) {
            ...
            if (beforeEvent && typeof beforeEvent === 'function') {
                beforeEvent.call(e, commandValue);
            }
            ...
            if (afterEvent && typeof afterEvent === 'function') {
                afterEvent.call(e, commandValue);
            }
        });
    };
...
_e(function (E, $) {
    ...
    E.config.familys = [
        '宋体', '黑体', '楷体', '微软雅黑',
        'NotoSans CJK', 'PingFangSC-Regular',
        ...
        'default': {
            ...
            data: [{
              ...
              icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/f0/dorachijing_thumb.gif'
                ...
                value: '[坏笑]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/50/pcmoren_huaixiao_org.png'
            }, {
                value: '[舔屏]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/40/pcmoren_tian_org.png'
            }, {
                value: '[污]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/3c/pcmoren_wu_org.png'
            }, {
                value: '[允悲]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/2c/moren_yunbei_org.png'
            }, {
                value: '[笑而不语]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/3a/moren_xiaoerbuyu_org.png'
            }, {
                value: '[费解]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/3c/moren_feijie_org.png'
            }, {
                value: '[憧憬]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/37/moren_chongjing_org.png'
            }, {
                value: '[并不简单]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/fc/moren_bbjdnew_org.png'
            }, {
                value: '[微笑]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/5c/huanglianwx_org.gif'
            }, {
                value: '[酷]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/8a/pcmoren_cool2017_org.png'
            }, {
                value: '[嘻嘻]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/0b/tootha_org.gif'
            }, {
                value: '[哈哈]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/6a/laugh.gif'
            }, {
                value: '[可爱]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/14/tza_org.gif'
            }, {
                value: '[可怜]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/af/kl_org.gif'
            }, {
                value: '[挖鼻]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/0b/wabi_org.gif'
            }, {
                value: '[吃惊]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/f4/cj_org.gif'
            }, {
                value: '[害羞]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/6e/shamea_org.gif'
            }, {
                value: '[挤眼]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/c3/zy_org.gif'
            }, {
                value: '[闭嘴]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/29/bz_org.gif'
            }, {
                value: '[鄙视]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/71/bs2_org.gif'
            }, {
                value: '[爱你]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/6d/lovea_org.gif'
            }, {
                value: '[泪]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/9d/sada_org.gif'
            }, {
                value: '[偷笑]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/19/heia_org.gif'
            }, {
                value: '[亲亲]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/8f/qq_org.gif'
            }, {
                value: '[生病]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/b6/sb_org.gif'
            }, {
                value: '[太开心]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/58/mb_org.gif'
            }, {
                value: '[白眼]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/d9/landeln_org.gif'
            }, {
                value: '[右哼哼]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/98/yhh_org.gif'
            }, {
                value: '[左哼哼]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/6d/zhh_org.gif'
            }, {
                value: '[嘘]',
                icon: 'http://img.t.sinajs.cn/t4/appstyle/expression/ext/normal/a6/x_org.gif'
            }, {
                value: '[衰]',
    ...
    // 上传图片的配置
    // 默认不启用 Base64
    E.config.uploadImgShowBase64 = false;
    // server地址
...
_e(function (E, $) {
     ...
     E.UI.menus = {
        ...
        audio: {
            normal: '<a href="#" tabindex="-1"><i class="wangeditor-menu-img-music"></i></a>',
            selected: '.selected'
        },
        location: {
    ...
    E.createMenu(function (check) {
        ...
        */
        ...
        menu.dropList = new E.DropList(editor, menu, {
            data: data,
            tpl: tpl,
            selectorForELemCommand: 'span[style]'  // 为了执行 editor.commandForElem 而传入的elem查询方式
        });

        // 定义 update selected 事件
        menu.updateSelectedEvent = function () {
            var rangeElem = editor.getRangeElem();
            rangeElem = editor.getSelfOrParentByName(rangeElem, 'span[style]');

            if (rangeElem) {
                if(rangeElem.style.fontFamily == ""){
                  return false;
                }else {
                  return rangeElem;
                }
    ...
    E.createMenu(function (check) {
        ...
        */
        ...
        menu.dropList = new E.DropList(editor, menu, {
            data: data,
            tpl: tpl, //font[size]
            selectorForELemCommand: 'span'  // 为了执行 editor.commandForElem 而传入的elem查询方式
        });
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        // 创建droplist
        var tpl = '<span style="line-height: 25px;">{#title}</span>';
        menu.dropList = new E.DropList(editor, menu, {
            data: data,
            tpl: tpl,
            selectorForELemCommand: 'ul',  // 为了执行 editor.commandForElem 而传入的elem查询方式
            beforeEvent: beforeEvent,
            afterEvent: afterEvent
        });
        ...
        menu.updateSelectedEvent = function () {
            var rangeElem = editor.getRangeElem();
            rangeElem = editor.getSelfOrParentByName(rangeElem, 'li');
            if (rangeElem) {
                return true;
            }
            return false;
        ...
        function beforeEvent(e) {
            var tempNode = null;
            if(editor.getRangeElem().tagName == "LI"){
                tempNode = $(editor.getRangeElem()).parent();
            }else if(editor.getRangeElem().tagName == "UL"){
                tempNode = $(editor.getRangeElem());
            }
            if(tempNode == null){ editor.command(e, 'InsertUnorderedList'); return; }
        }
        function afterEvent(e) {
            var tempNode = null;
            if(editor.getRangeElem().tagName == "LI"){
            ...
            if(e == '-1'){editor.command(e, 'InsertUnorderedList'); return;}
            if(tempNode == null){ return; }
            switch (e) {
              case '1':
                if(tempNode.css("list-style-type") == "decimal"){
                    editor.command(e, 'InsertUnorderedList');
                }else {
                    tempNode.css("list-style-type", "decimal");
                }
                break;
              case '●':
                if(tempNode.css("list-style-type") == "disc"){
                    editor.command(e, 'InsertUnorderedList');
                }else {
                    tempNode.css("list-style-type", "disc");
                }
                break;
              case '○':
                if(tempNode.css("list-style-type") == "circle"){
                    editor.command(e, 'InsertUnorderedList');
                }else {
                    tempNode.css("list-style-type", "circle");
                }
                break;
              case '■':
                if(tempNode.css("list-style-type") == "square"){
                    editor.command(e, 'InsertUnorderedList');
                }else {
                    tempNode.css("list-style-type", "square");
                }
                break;
              default:
                break;
    ...
    E.createMenu(function (check) {
        ...
        function insertEmotionImgs(data, $tabContent) {
            ...
            $.each(data, function (k, emotion) {
                ...
                var $command = $('<a href="javascript:;" title="' + value.replace('[','').replace(']','') + '" commandValue="' + commandValue + '"></a>');
                var $img = $('<img>');
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        editor.ready(function () {
            ...
            if (uploadImgUrl || customUpload || config.uploadImgShowBase64 == true) {
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        var editor = this;
        var lang = editor.config.lang;
        var reg = /^(http)|(https)/i;  // http... 或者 https... 格式
        ...
        var $linkInput = $('<input type="text" class="block" placeholder=\'视频源 URL(*.mp4、*.ogg)\'/>');
        ...
        $btnSubmit.click(function (e) {
            ...
            // 设置 src
            $video.attr('src', $linkInput.val());
            // 设置高度和宽度
            $video.attr('width', width).attr('height', height);

            // 拼接字符串
            html = html.replace('{content}', $div.append($video).html());
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        var $content = $('<div></div>');
        var $linkInputContainer = $('<div style="margin:20px 10px;"></div>');
        var $linkInput = $('<input type="text" class="block" placeholder=\'音频源 URL(*.mp3、*.ogg)\'/>');
        $linkInputContainer.append($linkInput);
        var $sizeContainer = $('<div style="margin:20px 10px;"></div>');
        var $widthInput = $('<input type="text" value="640" style="width:50px;text-align:center;"/>');
        var $heightInput = $('<input type="text" value="498" style="width:50px;text-align:center;"/>');
        ...
        $btnSubmit.click(function (e) {
            ...
            // 设置 src
            $audio.attr('src', $linkInput.val());
            // 设置高度和宽度
            $audio.attr('width', width).attr('height', height);

            // 拼接字符串
            html = html.replace('{content}', $div.append($audio).html());
...
_e(function (E, $) {
    ...
    E.plugin(function () {
        ...
        var uploadTimeout = config.uploadTimeout;
        var event;
        if (uploadImgUrl == '' && config.uploadImgShowBase64 == false) {
            return;
        }
...
_e(function (E, $) {
    ...
    UploadFile.fn.selected = function (e, input) {
        ...
        var progress = 0; self.editor.step = (100/files.length);
        self.editor.currentProgress = 0;

        self.editor.showUploadProgress(progress);
        // 遍历选中的文件，预览、上传
        $.each(files, function (key, value) {
            if(self.editor.config.uploadImgShowBase64 == true){
              self.base64File(value);
            }else {
              self.upload(value);
            }
        });
    };
    UploadFile.fn.base64File = function (file) {
      var self = this;
      var reader = new FileReader();
      reader.onload = function (e) {
        var base64 = e.target.result || this.result;
        self.editor.command(null, 'insertHtml', '<img src="' + base64 + '" style="width: 100px"/>');

        self.editor.currentProgress += self.editor.step;
        if(self.editor.currentProgress < 100){
          self.editor.showUploadProgress(self.editor.currentProgress);
        }else {
          self.editor.showUploadProgress(100);
          var timeout = setTimeout(()=>{
            self.editor.hideUploadProgress();
            clearTimeout(timeout);
          }, 500)
        }
      }
      reader.onerror = function (e) {
        console.warn("wangEditor提示: 文件读取错误。");
      }
      // 开始取文件
    ...
    UploadFile.fn.upload = function (file) {
        ...
        var ontimeout = uploadImgFns.ontimeout;
        var onerror = uploadImgFns.onerror;
        var onbeforeupload = uploadImgFns.onbeforeupload;
        var reader = new FileReader();

        if (!onload || !ontimeout || !onerror || !onerror || !onbeforeupload) {
            E.error('请为编辑器配置上传图片的 onbeforeupload onload ontimeout onerror 回调事件');
            return;
        }
        ...
        reader.onload = function (e) {
            ...
            if (onbeforeupload.call(self.editor, file) == true){
              var base64 = e.target.result || this.result;
              editor.xhrUploadImg({
                  event: e,
                  filename: filename,
...
_e(function (E, $) {
    ...
    UploadFile.fn.render = function () {
        ...
        var multipleTpl = multiple ? 'multiple="multiple"' : '';
        var $p = $('<p>选择图片并上传</p>');
        var $input = $('<input id="iptUpdateFile" type="file" ' + multipleTpl + ' name="' + uploadFileName + '"/>');
...
_e(function (E, $) {
    ...
    E.plugin(function () {
        ...
        var $triangle = $('<div class="tip-triangle"></div>');
        var $delete = $('<a href="#" title="删除"><i class="wangeditor-menu-img-trash-o"></i></a>');
        var $zoomSmall = $('<a href="#" title="缩小"><i class="wangeditor-menu-img-search-minus"></i></a>');
        var $zoomBig = $('<a href="#" title="放大"><i class="wangeditor-menu-img-search-plus"></i></a>');
...
_e(function (E, $) {
    ...
    E.plugin(function () {
        ...
        var $delete = $('<a href="#" title="删除"><i class="wangeditor-menu-img-trash-o"></i></a>');
        var $zoomSmall = $('<a href="#" title="缩小"><i class="wangeditor-menu-img-search-minus"></i></a>');
        var $zoom100 = $('<a href="#" title="自适应手机（width: 100%）"><i class="wangeditor-menu-img-enlarge2"></i></a>');
        var $zoomBig = $('<a href="#" title="放大"><i class="wangeditor-menu-img-search-plus"></i></a>');
        ...
        var $alignLeft = $('<a href="#" title="左对齐"><i class="wangeditor-menu-img-align-left"></i></a>');
        var $alignCenter = $('<a href="#" title="居中"><i class="wangeditor-menu-img-align-center"></i></a>');
        var $alignRight = $('<a href="#" title="右对齐"><i class="wangeditor-menu-img-align-right"></i></a>');
        var $link = $('<a href="#" title="链接"><i class="wangeditor-menu-img-link"></i></a>');
        var $unLink = $('<a href="#" title="取消链接"><i class="wangeditor-menu-img-unlink"></i></a>');
        ...
        function bindToolbarEvent() {
            ...
            //自适应手机(width: 100%)
            $zoom100.click(function (e) {
                commandFn = function () {
                    if($currentImg[0].style.width.includes("%") == false){
                      $zoom100.find("i").removeClass("wangeditor-menu-img-enlarge2");
                      $zoom100.find("i").addClass("wangeditor-menu-img-shrink2");
                      $zoom100.attr("title", "还原图片（width: 100px）");
                      $currentImg.css({
                          width: '100%',
                          height: 'auto'
                      });
                    }else {
                      $zoom100.find("i").removeClass("wangeditor-menu-img-shrink2");
                      $zoom100.find("i").addClass("wangeditor-menu-img-enlarge2");
                      $zoom100.attr("title", "自适应手机（width: 100%）");
                      $currentImg.css({
                          width: '100px',
                          height: 'auto'
                      });
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        // 为menu创建droplist对象
        var tpl = '<span style="padding-right: 50px;padding-left: 10px;line-height:{#commandValue}">{#title}</span>';
        menu.dropList = new E.DropList(editor, menu, {
            data: data,  // 传入数据源
            tpl: tpl  // 传入模板
        });
